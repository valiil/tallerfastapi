...
class PerfilController:
    ...
    def create_perfil(self, perfil: Perfil):   
        try:
            ...
            return {"resultado": "Perfil creado exitosamente"}
            ...
            raise HTTPException(status_code=500, detail=f"Error al crear el perfil en la base de datos: {err}")
    ...
    def get_perfiles(self):
        try:
            ...
            if not result:
                raise HTTPException(status_code=404, detail="Perfiles no encontrados")
    ...
    def update_perfil(self, perfil_id: int, perfil: Perfil):
        try:
            ...
            return {"resultado": "Perfil actualizado exitosamente"}

        except mysql.connector.Error as err:
            print(f"Error en la base de datos: {err}")
            if conn.is_connected():
                conn.rollback()
            raise HTTPException(status_code=500, detail=f"Error al actualizar el perfil en la base de datos: {err}")
    ...
    def delete_perfil(self, perfil_id: int):
        try:
            ...
            return {"resultado": "Perfil eliminado exitosamente"}

        except mysql.connector.Error as err:
            print(f"Error en la base de datos: {err}")
            if conn.is_connected():
                conn.rollback()
            raise HTTPException(status_code=500, detail=f"Error al eliminar el perfil en la base de datos: {err}")
...
# perfil_controller = PerfilController()  # Update this line if necessary
