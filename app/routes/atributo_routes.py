...
from app.controllers.atributo_controller import AtributoController  # Cambiado a AtributoController
from app.models.atributo_model import Atributo  # Cambiado a Atributo
